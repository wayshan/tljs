...
namespace Mx.Common
{
    ...
    public class Image
    {
        ...
        /// 图片等比缩放
        /// </summary>       
        /// <param name="fromFilePath">原图存放地址</param>
        /// <param name="savePath">缩略图存放地址</param>
        /// <param name="targetWidth">指定的最大宽度</param>
        /// <param name="targetHeight">指定的最大高度</param>
        /// <param name="watermarkText">水印文字(为""表示不使用水印)</param>
        /// <param name="watermarkImage">水印图片路径(为""表示不使用水印)</param>
        public static void ZoomAuto(string fromFilePath, string savePath, System.Double targetWidth, System.Double targetHeight, string watermarkText, string watermarkImage)
        {
            //创建目录
            string dir = Path.GetDirectoryName(savePath);
            if (!Directory.Exists(dir))
            ...
            //原始图片（获取原始图片创建对象，并使用流中嵌入的颜色管理信息）
            //System.Drawing.Image initImage = System.Drawing.Image.FromStream(fromFile, true);
            System.Drawing.Image initImage = System.Drawing.Image.FromFile(fromFilePath);
