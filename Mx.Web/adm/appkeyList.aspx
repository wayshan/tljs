<%@ Page Title="" Language="C#" MasterPageFile="~/adm/AdminBaseMaster.Master" AutoEventWireup="true"
    CodeBehind="appkeyList.aspx.cs" Inherits="Mx.Web.adm.appkeyList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPage" runat="server">
    <div class="span12">
        <div class="social-box">
            <div class="header">
                <div class="btn-group">
                    <a class="btn btn-primary" id="add-row" href="appkeyDo.aspx"><i class="icon-pencil"></i>
                        添加</a> 
                </div>
                        ...
                        <asp:Repeater ID="rpData" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <%#Eval("IsDefault").ToString() == "True" ? "<span class=\"label label-success\" title=\"Active\">是</span>" : "<span class=\"label\" title=\"Disabled\">否</span>"%>
                                    </td>
                                    <td>
